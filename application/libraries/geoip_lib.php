<?php (defined('BASEPATH') OR defined('SYSPATH')) or die('No direct access allowed.');
     ...
     *
     * (Espa�ol)
     * Esta librer�a usa la base de datos Geolite Country (formato binario) 
     * desde la direcci�n ip devuelve el pa�s, c�digo de pa�s, provincia, ciudad,
     * latitud, longitud, c�digo postal, c�digo metropolitano (USA), y c�digo de area.
     *
     ...
     * 
     * Puedes probar su funcionamiento usando el siguiente c�digo en tu p�gina: 
     *
     ...
     * Custom vars
     * 
     *  Tambi�n puedes usar la funci�n personalizada, para devolver la cadena formateada
     *
     *   %IP -> Ip Address
     *   %CO -> Country_code
     *   %C3 -> Country_code3
