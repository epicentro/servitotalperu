...
class parametros extends CI_Controller {
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idparametros', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        array('nombre_campo'=>'llave', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'LLave', 'multinivel'=>'no',  'valor'=>''),
        array('nombre_campo'=>'valor', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Valor', 'multinivel'=>'no',  'valor'=>''),
        array('nombre_campo'=>'descripcion', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Descripcion', 'multinivel'=>'no', 'valor'=>''),
        array('nombre_campo'=>'Orden', 'tipo'=>'varchar', 'show'=>'no', 'clave'=>'no', 'rotulo'=>'Orden', 'multinivel'=>'no', 'valor'=>''),
    ...
    public function listar(){
            ...
            $strsql="select $cadena_campos  from 
                     $this->tabla where idsw=1 order by id$this->tabla ";
            ...
            $this->image_lib->initialize($configThumb);
             ...
             if ( ! $this->image_lib->resize()){//En esta linea redimensionamos la imagen 
                ...
                echo $this->image_lib->display_errors();
                                ...
                                $configThumb1['width'] = 15;
                                $configThumb1['height'] = 45;
