 ...
 * @author Yasser
 */
class categoria_videos extends CI_Controller {
    //put your code here
     
    public $tabla="categoria_videos";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idcategoria_videos', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
