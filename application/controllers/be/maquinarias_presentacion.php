 ...
 * @author Yasser
 */
class maquinarias_presentacion extends CI_Controller {
    //put your code here
   ...
   public function grabar(){
       ...
       $strsql="update maquinarias set descripcion='$valor' where idmaquinarias='$id'";
       $this->modelo_base->ejecuta($strsql);
       $url=base_url()."be/maquinarias_presentacion/listar/$id";
