 ...
 * @author Yasser
 */
class normas extends CI_Controller {
    //put your code here
     
    public $tabla="normas";
    public $idtabla="idnormas";
    public $carpeta_img="img_normas";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idnormas', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        ...
        array('nombre_campo'=>'nombre', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Título', 'multinivel'=>'no', 'valor'=>''),
        ...
        //array('nombre_campo'=>'sumilla_facebook', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'SumillaFacebook', 'multinivel'=>'no', 'valor'=>''),
        array('nombre_campo'=>'fecha', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Fecha (DD-MM-YYYY)', 'multinivel'=>'no', 'valor'=>''),
        //array('nombre_campo'=>'Autor', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'autor', 'multinivel'=>'no', 'valor'=>''),
    ...
    public function listar(){
            ...
            $strsql="select $cadena_campos  from 
                     $this->tabla order by fecha desc ";
   ...
   public function imagen(){
      ...
      $this->validacion->validacion_login();
       ...
       $aleatorio=random_string('alnum', 5);   
        ...
        $config['allowed_types'] = 'doc|pdf|docx|xls|xlsx|pdf|txt|gif|jpg|png';
