...
class maquinarias extends CI_Controller {
    ...
    public $tabla="maquinarias";
    public $idtabla="idmaquinarias";
    public $carpeta_img="img_maquinarias";
    
    public $tabla_padre="categoria_maquinarias";
    public $idtabla_padre="idcategoria_maquinarias";
        ...
        $this->validacion->validacion_login();
         ...
         $valor=$this->modelo_base->ejecuta($strsql);
             ...
             if($valor==1){
                 ...
                 $idmaquinarias=$this->db->insert_id();
                 $idusuario=$this->session->userdata("idusuarios");
                 //Actualizamos el Kardex
                 //$this->be_funciones->kardex('1',$stock, $idmaquinarias, $idusuario , '' , '' );
...
public function editar(){
   ...
   public function stock(){
       ...
       $strsql="update maquinarias set stock='$stock' where idmaquinarias='$id'";
       $valor=$this->modelo_base->ejecuta($strsql);
       if($valor==1){
   ...
   public function atributos(){
       ...
       if($verificar=="0"){
           $strsql="INSERT into maquinarias_atributos (idmaquinarias, idatributos) values ('$id', '$cbo_atributos')";
           $valor=$this->modelo_base->ejecuta($strsql);
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
           //Averiguamos si la categoria tiene maquinarias dependiente
 ...
 function elimina_maquinarias(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
          $strsql="select count(*) as cantidad from detalle where idmaquinarias='$id'";
          $row=$this->modelo_base->c_una_fila($strsql);
          if($row->cantidad > 0 ){
          ...
          */
           ...
           //eliminamos  de maquinarias atributos
            //$strsql="delete from maquinarias_atributos where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            
            //eliminamos  de maquinarias_comentarios
            //$strsql="delete from maquinarias_comentarios where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
