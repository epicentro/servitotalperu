...
class productos_imagenes extends CI_Controller {
    ...
    public $tabla="productos_imagenes";
    public $idtabla="idproductos_imagenes";
                                        ...
                                        $this->equi_foto($file, $ruta, $ancho_deseado, $alto_deseado);
                                           ...
                                           if ( ! $this->image_lib->resize()){//En esta linea redimensionamos la imagen a 170 x 220
                                               ...
                                               echo $this->image_lib->display_errors();
                                                        ...
                                                        $idproductos_imagenes=$this->uri->segment(5);
                                                        if($idproductos_imagenes=="0"){//si es igual a cero es nuevo registro

                                                                //Ya tenemos creado la imagen y el Thumbnails, ahora grabamos

                                                                $strsql="insert into $this->tabla ( imagen, idproductos )values ('$file','$id')";
                                                                $valor=$this->modelo_base->ejecuta($strsql);

                                                        }else{//si $idproductos_imagenes no es cero entonces es una actualizacion


                                                                //ANTES DE GRABAR BORRAMOS EL LAS IMAGENES ANTERIORES
                                                                $strsql="select imagen from $this->tabla where id$this->tabla='$id' and idproductos_imagenes='$idproductos_imagenes'";
                                                                ...
                                                                //ACTUALIZAMOS
                                                                $strsql="update $this->tabla set imagen='$file', idproductos='$id' where 
                                                                        idproductos_imagenes='$idproductos_imagenes'";
   ...
   function elimina_productos_imagenes(){
