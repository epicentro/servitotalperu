...
class clientes extends CI_Controller {
    ...
    public $idtabla="idclientes";
    public $carpeta_img="img_clientes";
    
    public $tabla_padre="categoria_clientes";
    public $idtabla_padre="idcategoria_clientes";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idclientes', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        //array('nombre_campo'=>'idcategoria_clientes', 'tipo'=>'varchar', 'show'=>'si' ,'clave'=>'foranea', 'rotulo'=>'Categoria', 'multinivel'=>'si', 'valor'=>''),
    ...
    public function listar(){
            ...
            // Por lo tanto uno de ellos siempre estara vacia  
             $strsql="select $cadena_campos  from $this->tabla $buscar1 $buscar2 order by orden,".$this->idtabla;
