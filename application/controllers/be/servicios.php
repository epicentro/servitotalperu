...
class servicios extends CI_Controller {
    ...
    public $tabla_padre="categoria_servicios";
    public $idtabla_padre="idcategoria_servicios";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'video', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Video Youtube', 'multinivel'=>'no', 'valor'=>''),        
        ...
        $this->validacion->validacion_login();
         ...
         $valor=$this->modelo_base->ejecuta($strsql);
             ...
             if($valor==1){
                 ...
                 $idservicios=$this->db->insert_id();
                 $idusuario=$this->session->userdata("idusuarios");
                 //Actualizamos el Kardex
                 //$this->be_funciones->kardex('1',$stock, $idservicios, $idusuario , '' , '' );
...
public function editar(){
   ...
   public function stock(){
       ...
       $strsql="update servicios set stock='$stock' where idservicios='$id'";
       $valor=$this->modelo_base->ejecuta($strsql);
       if($valor==1){
   ...
   public function atributos(){
       ...
       if($verificar=="0"){
           $strsql="INSERT into servicios_atributos (idservicios, idatributos) values ('$id', '$cbo_atributos')";
           $valor=$this->modelo_base->ejecuta($strsql);
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
           //Averiguamos si la categoria tiene servicios dependiente
 ...
 function elimina_servicios(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
          $strsql="select count(*) as cantidad from detalle where idservicios='$id'";
          $row=$this->modelo_base->c_una_fila($strsql);
          if($row->cantidad > 0 ){
          ...
          */
           ...
           //eliminamos  de servicios atributos
            //$strsql="delete from servicios_atributos where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            
            //eliminamos  de servicios_comentarios
            //$strsql="delete from servicios_comentarios where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            ...
            $strsql="select imagen from servicios_imagenes where id$this->tabla='$id'";
            $fila=$this->modelo_base->c_una_fila($strsql);
            //echo $fila."sss";
            if($fila<>"0"){
