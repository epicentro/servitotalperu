 ...
 * @author Yasser
 */
class categoria_maquinarias extends CI_Controller {
    //put your code here
     
    public $tabla="categoria_maquinarias";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idcategoria_maquinarias', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
...
public function editar(){
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          $strsql="select count(*) as cantidad from maquinarias where id$this->tabla='$id'";
