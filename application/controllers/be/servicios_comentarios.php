 ...
 * @author Yasser
 */
class productos_comentarios extends CI_Controller {
    //put your code here
     
    public $tabla="productos_comentarios";
    public $idtabla="idproductos_comentarios";
    public $tabla_padre="productos";
    public $idtabla_padre="idproductos";
    public $carpeta_img="img_productos_comentarios";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idproductos_comentarios', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        ...
        array('nombre_campo'=>'comentario', 'tipo'=>'text', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Comentario', 'multinivel'=>'no', 'valor'=>''),
...
public function editar(){
   ...
   function elimina_productos_comentarios(){
