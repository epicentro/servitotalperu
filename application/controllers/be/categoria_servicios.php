 ...
 * @author Yasser
 */
class categoria_servicios extends CI_Controller {
    //put your code here
     
    public $tabla="categoria_servicios";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idcategoria_servicios', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
