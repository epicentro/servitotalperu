 ...
 * @author Yasser
 */
class maquinarias_imagenes extends CI_Controller {
    //put your code here
     
    public $tabla="maquinarias_imagenes";
    public $idtabla="idmaquinarias_imagenes";
    public $carpeta_img="img_maquinarias";
    
    public $tabla_padre="maquinarias";
    public $idtabla_padre="idmaquinarias";
                                        ...
                                        $this->equi_foto($file, $ruta, $ancho_deseado, $alto_deseado);
                                           ...
                                           if ( ! $this->image_lib->resize()){//En esta linea redimensionamos la imagen a 170 x 220
                                               ...
                                               echo $this->image_lib->display_errors();
                                                        ...
                                                        $idmaquinarias_imagenes=$this->uri->segment(5);
                                                        if($idmaquinarias_imagenes=="0"){//si es igual a cero es nuevo registro

                                                                //Ya tenemos creado la imagen y el Thumbnails, ahora grabamos

                                                                $strsql="insert into $this->tabla ( imagen, idmaquinarias )values ('$file','$id')";
                                                                $valor=$this->modelo_base->ejecuta($strsql);

                                                        }else{//si $idmaquinarias_imagenes no es cero entonces es una actualizacion


                                                                //ANTES DE GRABAR BORRAMOS EL LAS IMAGENES ANTERIORES
                                                                $strsql="select imagen from $this->tabla where id$this->tabla='$id' and idmaquinarias_imagenes='$idmaquinarias_imagenes'";
                                                                ...
                                                                //ACTUALIZAMOS
                                                                $strsql="update $this->tabla set imagen='$file', idmaquinarias='$id' where 
                                                                        idmaquinarias_imagenes='$idmaquinarias_imagenes'";
   ...
   function elimina_maquinarias_imagenes(){
