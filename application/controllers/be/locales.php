...
class locales extends CI_Controller {
    ...
    public $tabla="locales";
    public $idtabla="idlocales";
    public $carpeta_img="img_locales";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idlocales', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
