                <div class="container">
                    <h2>Maquin&aacute;ria: <strong><?php echo $titulo; ?></strong></h2>
                    ...
                    <div class="row mb-xlg">
                        <div class="col-sm-4">
                            ...
                            foreach ($imagenes as $key => $value) {
                                ?>
                                <div>
                                <img class="pull-left mr-xlg img-responsive" alt="<?php echo $titulo; ?>" src="<?php echo base_url()."img_maquinarias/".$value->imagen; ?>" style="">
                                </div>
                                <?php
                            }
                            ?>
						...
						if(trim($video)<>""){?>
							<div class="col-xs-12 col-sm-12 col-md-11 col-md-offset-1 mt-xl mb-xl">
								<iframe class="new_video" border="0"
