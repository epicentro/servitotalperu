<div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
				<h2 class="ico_mug">Sección: <?php echo $titulo; ?></h2>
				<div class="clearfix">
                         <br />
...
<script type="text/javascript">
 function validar(){
      ...
      <form id="form1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>be/secciones/graba/<?php echo $seo; ?>" onsubmit="return validar();" >
