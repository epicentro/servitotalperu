	...
	<tr>
            ...
            <td style="text-align: center;"  >
                   ...
                   <?php
                              if($row->imagen!=""){
                   ?>
                <a target="_blank" href="<?php echo base_url().$this->carpeta_img."/".$row->imagen; ?>"><img width="50" src="<?php echo base_url()?>img/pdf-icon.png" /><br/></a>
            ...
            <th  >
                    ...
                    <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/$this->tabla/v_editar/".$row->$idtabla;?>',1000,650);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                     <img class="img_link" onclick = "javascript:elimina_articulos('<?php echo $row->$idtabla; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>    
