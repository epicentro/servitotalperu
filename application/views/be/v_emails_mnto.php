  <div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
				<h2 class="ico_mug"> Mnto. de Emails</h2>
				<div class="clearfix">
...
<table  cellpadding="0" cellspacing="0" class="tb_mnto" >
	...
	<tr>
            <td ><?php echo $row->idemails; ?></td>
            <td style="text-align:center; " ><?php echo $row->nombre; ?></td>
            <td style="text-align:center; " ><?php echo $row->de; ?></td>
            
            <th  >

                    <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/$this->tabla/v_editar/".$row->idemails;?>',1000,650);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                     <img class="img_link" onclick = "javascript:elimina_locales('<?php echo $row->idemails; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>    
