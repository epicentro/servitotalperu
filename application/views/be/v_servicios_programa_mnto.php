 ...
 <script type="text/javascript" src="<?php echo base_url();?>js/fckeditor/fckeditor.js"></script>
    ...
    <div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
				<h2 class="ico_mug"> Sumilla para : <?php echo $nombre; ?></h2>
				<div class="clearfix">
                         ...
                         <form id="form1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>be/productos_programa/grabar/<?php echo $id; ?>" onsubmit="return validar();" >
...
<!--seo_title, seo_descripcion, seo_keywords, text_html-->
                                       ...
                                       <tr>
                                                ...
                                                <td>
                                                <textarea name="programa" id="programa" rows="10" cols="20" ><?php echo $valor; ?></textarea>
                                                <script>
                                                
                                                            var oFCKeditor = new FCKeditor( 'programa' ) ;
